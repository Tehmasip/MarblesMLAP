...
public class KitchenGameLobby : MonoBehaviour {
    ...
    // perh lia ye srf unity play servies ko initailze kerta ha
    private void Awake() {
        Instance = this;
    ...
    private async void InitializeUnityAuthentication() {
        if (UnityServices.State != ServicesInitializationState.Initialized) {
            ...
            await UnityServices.InitializeAsync(initializationOptions);//perh lia ya bhi unity servies ko set kia ja raha ha yahan per

#if !DEDICATED_SERVER
            await AuthenticationService.Instance.SignInAnonymouslyAsync();// if not server no need for authentication
#endif
